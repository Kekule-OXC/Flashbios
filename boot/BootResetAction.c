...
void DisplayXboxVersion(void)
{
	char Ver[20] = {0};
	char xboxVersion[20] = {0};
	DWORD value;
	
	printk("Video Encoder Detected: ");
	...
	// detect xbox version
	Ver[0] = I2CTransmitByteGetReturn(0x10, 2);
	Ver[1] = I2CTransmitByteGetReturn(0x10, 2);
	Ver[2] = I2CTransmitByteGetReturn(0x10, 2);
	Ver[3] = I2CTransmitByteGetReturn(0x10, 2);
	Ver[4] = I2CTransmitByteGetReturn(0x10, 2);
	Ver[5] = I2CTransmitByteGetReturn(0x10, 2);
	Ver[6] = I2CTransmitByteGetReturn(0x10, 2);
	Ver[7] = I2CTransmitByteGetReturn(0x10, 2);
	Ver[8] = I2CTransmitByteGetReturn(0x10, 2);
...
//	printk(Ver);
	...
	strcpy(xboxVersion, "XBOX UNKNOWN");
	if (strcmp((char*)Ver,"P2L")==0) strcpy(xboxVersion,"XBOX V1.6");
...
//	DumpAddressAndData(0, (BYTE *)&eeprom, 256);
	...
	*/
	...
	printk("See www.xbox-scene.com for help!\n");
        printk("\n");
	...
	startCursorY=VIDEO_CURSOR_POSY;
